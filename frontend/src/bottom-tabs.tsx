...
// Routes where the shell tabs are visible. /home исключён — он больше не
// участвует в основном флоу (role-кабинеты имеют свою tab-навигацию).
// Оставляем только служебные L0-экраны, у которых нет собственного layout.
const SHELL_ROUTES = new Set(['work', 'activity', 'profile', 'inbox', 'workspace', 'project', 'hub']);
